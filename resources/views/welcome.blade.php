    ...
    <div class="container mt-5">
        ...
        @endif
            ...
            <div style="text-align: center">
                @if( Session::get('status')==false)
                    ...
                    <span class="badge rounded-pill bg-danger"> {{$message}}</span>
      ...
      <form action="{{route('create.url')}}" method="post">
          ...
          <div class="input-group mb-3">
              <input name="url" type="text" class="form-control" placeholder="Past your long URL" aria-label="Search" aria-describedby="search-icon">
              <span class="input-group-text" id="search-icon">
            <button type="submit" class="btn btn-sm btn-success">Shorten</button>
        </span>
          </div>
          <small>If need store your shorter URLs Please Login/Register</small>
